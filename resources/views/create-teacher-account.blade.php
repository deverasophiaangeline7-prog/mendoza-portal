            ...
            <div class="grid grid-cols-2 gap-x-16 gap-y-6">
                        ...
                        <div class="flex items-center">
                            ...
                            <div class="flex flex-col w-full">
                                <input type="file" 
                                    ...
                                    id="profile_photo"
                                    accept=".png, .jpg, .jpeg" 
                                    class="form-input-pill bg-white py-1 transition-colors @error('profile_photo') border-red-600 ring-1 ring-red-600 @enderror"
                                    :class="fileError ? 'border-red-600 ring-1 ring-red-600' : ''"
                                    @change="
                ...
                <div class="space-y-5">
                    <div class="flex items-center">
                        ...
                        <select name="gender" class="form-input-pill bg-white cursor-pointer focus:outline-none @error('gender') border-red-600 @enderror">
                    ...
                    <div class="flex flex-col">
                        <div class="flex items-center">
                            ...
                            <input type="text" 
                                   name="username" 
                                   class="form-input-pill @error('username') border-red-600 @enderror" 
                                   value="{{ old('username') }}" 
                                   required>
                        </div>
                        @error('username')
                        ...
                        <div class="flex flex-col">
                            <div class="flex items-center">
                                ...
                                <input type="password" 
                                       name="password" 
                                       x-model="pw" 
                                       class="form-input-pill @error('password') border-red-600 @enderror" 
                                       required>
                            </div>
                            @error('password') <span class="text-red-600 text-sm ml-40 mt-1 font-bold italic">{{ $message }}</span> @enderror
                        </div>

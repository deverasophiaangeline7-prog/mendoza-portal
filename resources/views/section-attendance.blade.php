        ...
        <nav class="w-64 bg-[#b91c1c] text-white pt-4">
            <ul class="space-y-1">
                ...
                <li class="bg-orange-400 mx-2 rounded-lg">
                    <a href="{{ route('attendance.index') }}" class="flex items-center p-3 space-x-3 text-black"><i class="fa-solid fa-calendar-check w-6"></i><span class="font-bold">Attendance</span></a>
                </li>
            </ul>
        </nav>
